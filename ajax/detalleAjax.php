...
}//if que verifica si se ha enviado un valor para el parámetro "idFactura" a través de una solicitud POST. Si se ha enviado un valor, crea una nueva instancia de la clase AjaxDetalle y llama al método ajaxUpdateDetalle() utilizando el valor enviado.
