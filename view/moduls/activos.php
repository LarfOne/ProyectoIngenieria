                ...
                <td>
                  <div class="btn-group">
                    <button style="margin: 5px" class="btn btn-warning btnUpdate btnUpdateActivo" codigo=<?php echo $activo['codigo']; ?>
                      data-bs-toggle="modal" data-bs-target="#modalUpdateActivo"><i class="fa fa-pencil"></i>
                    </button>
      ...
      <form role="form" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="box-body modalAct">
            ...
            <!--AGREGAR ID DE SUCURSAL EN LA QUE ESTARÁ EL ACTIVO-->
            <?php
              $item = null;
              $valor = null;
            ...
            <!--AGREGAR DESCRIPCION DEL ACTIVO-->
            <div class="form-group">
              <div class="input-group">
            ...
            <!--AGREGAR EMPLEADO ENCARGADO DEL ACTIVO-->
            <?php
              $item = null;
              $valor = null;
      ...
      <form role="form" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="box-body modalAct">
            ...
            <!--MODIFICAR DE CODIGO QUE ES SOLO VISIBLE-->
            <div class="form-group">
              <div class="input-group">
            ...
            <!--MODIFICAR DE DESCRIPCION DEL ACTIVO-->
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-map"></i></span>
            ...
            <!--MODIFICAR DE ESTADO DEL ACTIVO-->
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-phone"></i></span>
            ...
            <!--MODIFICAR DE EMPLEADO ENCARGADO-->
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                  <select class="form-control input-lg" id="empleado_idm" name="empleado_idm" style="border-radius: 5px;">
                    <option value="" disabled selected>Selecciona el nuevo empleado a cargo</option>
                    <?php foreach ($user as $user1) { ?>
                      <?php if ($user1['estado']!='Inactivo') { ?>
                        <option value=<?php echo $user1['cedula'] ?>><?php echo $user1['nombre']." ".$user1['apellidos'] ?></option>
                      <?php } ?>
